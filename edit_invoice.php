        ...
        <div class="row">
            <div class="col-md-4 p-4">
                <div class="from-group">
                    ...
                    <select name="supplier_name" id="supplier_name" class="form-select">
                        <?php 
                        if ($allSupplier=$con->query("SELECT * FROM supplier WHERE id=$getInvoiceId ")) {
                            while ($rows=$allSupplier->fetch_array()) {
                                echo '<option value="'.$rows['supplier_name'].'" selected >'.$rows['supplier_name'].'</option>';
                            }
                        }
            ...
            <div class="col-md-12">
                <table class="table table-bordered" >
                    ...
                    <tbody id="tableRow">
                    <?php 
                    $allInvoice=$con->query("SELECT * FROM invoice_details WHERE invoice_id=$getInvoiceId ");
                       while ($rows=$allInvoice->fetch_assoc()) {
                         ?>
                        <?php 
                        ...
                        <tr>
                            <td>
                                <select name="product_name[]" class="form-select product_name">
                                    <option selected value="<?php echo $rows['product_name'];?>"><?php echo $rows['product_name'];?></option>
                                </select>
                            </td>
                            <td>
                                <select name="product_unit[]" class="form-select product_unit">
                                <option selected value="<?php echo $rows['product_unit'];?>"><?php echo $rows['product_unit'];?></option>
                ...
                <table class="table table-bordered" >
                    ...
                    <tfoot class="">
                        <tr>
                            ...
                            <button type="button" id="addRowBtn" class="btn-sm btn btn-primary">Add Row</button>
                            </th>
                        </tr>
                    </tfoot>
                </table>
...
$(document).ready(function() {
    ...
    $('#addRowBtn').click(function() {
        var newRow = `
            <tr id="row${rowCounter}">
                ...
                <td><button class="removeRowBtn" data-row="${rowCounter}">Remove</button></td>
            </tr>
        `;
    ...
    // Calculate total and handle row removal
    $('#tableRow').on('input', '.qty, .price, .discount', function() {
        var row = $(this).closest('tr');
    ...
    $('#tableRow').on('click', '.removeRowBtn', function() {
